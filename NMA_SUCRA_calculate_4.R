...
write.csv(result_matrix_eff, "400_eff.csv")
write.csv(result_matrix_fifty, "400_fifty.csv")
write.csv(result_matrix_safety, "400_safety.csv")

save.image("/Users/Jessie/Desktop/000_UPenn_Research/000_project/000_with_Rui/summer_2019_with_Rui/0_NMA/SUCRA_Results_JT_4.RData")
