...
write.csv(result_matrix_eff, "200_eff.csv")
write.csv(result_matrix_fifty, "200_fifty.csv")
write.csv(result_matrix_safety, "200_safety.csv")

save.image("/Users/Jessie/Desktop/000_UPenn_Research/000_project/000_with_Rui/summer_2019_with_Rui/0_NMA/SUCRA_Results_JT_2.RData")
